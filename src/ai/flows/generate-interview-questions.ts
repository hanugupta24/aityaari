'use server';
/**
 * @fileOverview This file defines a Genkit flow for generating interview questions based on user profile and role.
 *
...
const prompt = ai.definePrompt({
  ...
  prompt: `You are an expert interviewer. Generate interview questions based on the user's profile and role.
