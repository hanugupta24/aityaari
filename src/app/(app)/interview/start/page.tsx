    ...
    <div className="max-w-2xl mx-auto space-y-8 py-8">
      <Card className="shadow-lg">
        <CardHeader>
          ...
          <CardDescription>
            Choose your preferred interview duration and prepare for a focused
            session.
          </CardDescription>
        </CardHeader>
        <CardContent className="space-y-6">
          ...
          {!isLoadingState && userProfile && isProfileEssentialDataMissing && (
            ...
            >
              ...
              <AlertDescription className="text-yellow-600 dark:text-yellow-200">
                ...
                'Profile Field'. This is needed for tailored questions. Please{" "}
                <Link
                  href="/profile"
          ...
          <div>
            ...
            <RadioGroup
              defaultValue="30"
              onValueChange={(value: "15" | "30" | "45") => setDuration(value)}
            ...
            >
              {["15", "30", "45"].map((d) => (
                <div key={d} className="flex items-center space-x-2">
                  ...
                  />
                  <Label htmlFor={`duration-${d}`} className="cursor-pointer">
                    {d} minutes
                  </Label>
                </div>
              ))}
          ...
          <div>
            <Label
              ...
              className="text-lg font-semibold mb-2 block flex items-center"
            >
          ...
          <Alert>
            ...
            <AlertDescription>
              <ul className="list-disc list-inside space-y-1 mt-2 text-sm">
                ...
                <li>
                  The interview will be recorded for feedback purposes (video &
                  audio for oral part).
                </li>
                <li>
                  For technical roles, be prepared for an initial oral section
                  followed by written technical/coding questions.
                </li>
                <li>Speak clearly. Your answers will be transcribed.</li>
                <li>
                  Proctoring is active: Avoid switching tabs, ensure your face
                  is visible, and stay engaged to prevent interview termination.
                </li>
              </ul>
            </AlertDescription>
          </Alert>
          ...
          <div className="space-y-4">
            ...
            >
              ...
              <div className="flex-1">
                ...
                <p className="text-xs text-muted-foreground">
                  Required for video and oral answers.
                </p>
              </div>
              {!permissionsGranted && (
                <Button
            ...
            <div className="items-top flex space-x-2 p-3 border rounded-md">
              <Checkbox
                ...
                onCheckedChange={(checked) => setAgreedToMonitoring(!!checked)}
                disabled={isStartingSession || isLoadingState}
              />
              <div className="grid gap-1.5 leading-none">
                ...
                <p className="text-sm text-muted-foreground">
                  This includes recording for quality, feedback, and proctoring.
          ...
          {!isLoadingState && userProfile && interviewLimitReached && (
            <Alert variant="destructive">
              ...
              <AlertDescription>
                ...
                <Button
                  variant="link"
                  className="p-0 h-auto text-destructive-foreground underline hover:text-destructive-foreground/80"
